<template>
  ...
  >
    <div class="scrollView" :style="{ height: scrollHeight }">
      ...
      <configurePermissions-info
        ref="configurePermissionsInfo"
        :data="data"
        v-if="data.type === 'configurePermissions'"
...
import configurePermissionsInfo from './configurePermissions.vue';
...
export default {
  ...
  methods: {
    ...
    closeedit() {
      ...
      if (this.$refs.configurePermissionsInfo) {
        this.$refs.configurePermissionsInfo.cancelForm();
      }
    },
    canceledit(type) {
      this.closeedit();
    ...
    confirmedit() {
      ...
      if (this.$refs.configurePermissionsInfo) {
        this.$refs.configurePermissionsInfo.submitFormItem();
      }
    },
    successSubmit() {
      this.closeedit();
