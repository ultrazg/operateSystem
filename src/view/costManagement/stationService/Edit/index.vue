<template>
  <dialog-cont
    ...
    ref="dialog"
    :confirmShow="data.configType !== 'detail' && data.configType !== 'cost'"
  >
    <div class="scrollView" :style="{ height: scrollHeight }">
      ...
      <costDetailInfo ref="costDetailInfo" :data="data" v-if="data.type === 'costDetail'" @success="successSubmit" />
    </div>
  </dialog-cont>
</template>
...
import costDetailInfo from './costDetail.vue';
