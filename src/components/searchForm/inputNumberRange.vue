  ...
  methods: {
    ...
    handleInputChangeFrom(value) {
      ...
      if (typeof this.userInputTo === 'number') {
        this.userInputForm =
          parseFloat(this.userInputForm) <= parseFloat(this.userInputTo) ? this.userInputForm : this.userInputTo;
      }
    ...
    handleInputChangeTo(value) {
      ...
      if (typeof this.userInputForm === 'number') {
        this.userInputTo =
          parseFloat(this.userInputTo) >= parseFloat(this.userInputForm) ? this.userInputTo : this.userInputForm;
      }
      this.$emit('input', [this.userInputForm, this.userInputTo]);
